...
async def send_vid(bot: Client, m: Message,cc,filename,thumb,name,prog,keyboard):   
    ...
    try:   
        await m.reply_video(filename,caption=cc, supports_streaming=True,height=720,width=1280,thumb=thumbnail,duration=dur, progress=progress_bar,progress_args=(reply,start_time), reply_markup=keyboard)   
    except Exception:   
